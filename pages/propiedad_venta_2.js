...
const contenedor_venta2 = $.querySelector('#venta-2 > div');

function renderCardsVenta(contenedor, informacion) {
 ...
 renderCardsVenta(contenedor_venta2, propiedades_alquiler)
